"""Regression checks for the amber-model-eval-yard casebook."""
...
from casebook.harness import assert_expected, amber_model_eval_yard_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(amber_model_eval_yard_summary(), assert_expected())
